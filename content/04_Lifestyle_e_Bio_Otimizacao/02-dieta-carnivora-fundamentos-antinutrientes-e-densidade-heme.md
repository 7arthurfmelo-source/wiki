---
title: "02. Dieta Carnívora — Fundamentos, Antinutrientes e Densidade Heme"
publish: true
description: "A biologia da guerra química vegetal, a extrema biodisponibilidade da carne vermelha e por que não existe carboidrato essencial para a fisiologia humana."
tipo: artigo
...
aliases:
  ...
  - "Fundamentos da Dieta Carnívora e Antinutrientes"
  - "02-dieta-carnivora-fundamentos-e-densidade-heme"
---
...
```mermaid
graph TD
    A["Antinutrientes Vegetais"] --> O["1. Oxalatos<br>(Cristais pontiagudos de ácido oxálico)"]
    A --> L["2. Lectinas<br>(Proteínas adesivas resistentes à digestão)"]
    A --> F["3. Fitatos<br>(Quelantes de minerais essenciais)"]
    A --> S["4. Salicilatos & Polifenóis<br>(Defensivos químicos anti-herbívoros)"]
    
    O --> D1["Microcálculos renais, dores articulares e quelamento de cálcio"]
    L --> D2["Agressão ao epitélio intestinal e permeabilidade (Leaky Gut)"]
    F --> D3["Bloqueio da absorção de Zinco, Ferro e Magnésio"]
    S --> D4["Reatividade imunológica e intolerâncias digestivas"]
```
