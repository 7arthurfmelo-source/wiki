---
title: "Experimento Mental — Oferta, Demanda e a Formação de Preços"
publish: true
description: "Um experimento mental didático ancorado na teoria austríaca e na formação dinâmica de preços como sinais de escassez e coordenação de mercado."
tipo: conceito
...
```mermaid
flowchart TD
    subgraph Cenario1["Cenário 1: Equilíbrio Inicial"]
        S1["Oferta: 100 peixes / semana"] <--> D1["Demanda: 100 compradores"]
        P1["Preço de Equilíbrio: 10 conchas / peixe"]
    end

    subgraph Cenario2["Cenário 2: Choque Positivo de Oferta (Produtividade)"]
        S2["Oferta salta para 200 peixes"] --> Q2["Abundância Relativa"]
        Q2 --> P2["Novo Preço: 5 conchas / peixe<br>(Poder de Compra Dobra!)"]
    end

    subgraph Cenario3["Cenário 3: Choque de Demanda / Escassez"]
        S3["Tempestade reduz oferta para 50 peixes"] --> Q3["Escassez Crítica"]
        Q3 --> P3["Novo Preço: 20 conchas / peixe<br>(Racionamento Espontâneo)"]
    end
```
