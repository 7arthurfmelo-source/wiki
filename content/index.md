---
title: "Wiki Pessoal — Arthur"
publish: true
description: "Caderno público de anotações, estudos e reflexões no Obsidian: Inteligência Artificial, Estudos, Economia e Soberania Digital."
---
...
Este espaço é o meu caderno público de anotações e estudos no Obsidian. Aqui eu compartilho um pouco do que venho aprendendo, minhas visões de mundo e reflexões sobre temas que me interessam profundamente — com a intenção genuína de que algo disso possa ser útil, inspirador ou prático para você também.

---

## 📬 Contato, Conversas & Apoio

Se algum texto te ajudou, se você achou algo interessante e quiser trocar uma ideia, pedir para eu aprofundar em algum assunto ou até me avisar de algum ponto que não ficou claro ou poderia ser melhor explicado:

* ✉️ **E-mail de Contato:** `1arthur.fmelo@gmail.com`

> ☕ **Apoio Voluntário:** Se você sentiu que algum conteúdo gerou valor real para você e quiser apoiar a continuidade deste projeto, o e-mail acima também funciona como **chave Pix**. Toda contribuição é 100% voluntária e muito bem-vinda!

---

## 🧭 O que você vai encontrar por aqui (Trilhas de Estudo)
...
- **[[02-ia-na-pratica-prompting-em-3-partes|02. Prompting em 3 Partes — A Sintaxe de Controle da Máquina]]** — *Desmistificando o prompt: por que comandos vagos geram respostas medíocres e como estruturar instruções de controle com Papel, Contexto e Restrição de Saída.*
- **[[03-ia-na-pratica-o-operador-no-comando-e-contexting|03. Engenharia de Contexto — O Córtex do Segundo Cérebro]]** — *Por que reexplicar contexto todo dia queima 80% dos tokens: dominando a gestão da janela de contexto, o combate ao Context Rot e a persistência JIT no Obsidian.*
- **[[04-ia-na-pratica-a-era-dos-agentes-e-automacoes|04. Agentes e Automação — A Era da Ação Autônoma]]** — *De chats estáticos para assistentes autônomos locais: entenda como a IA orquestra tarefas no seu computador e configure disjuntores de segurança determinísticos (N0 a N4).*
- **[[05-ia-na-pratica-ai-slop-e-o-pos-soberano|05. AI Slop e o POS — Proof of Work vs Conteúdo Sintético]]** — *O risco do código e conteúdo lixo (AI Slop), a ilusão do MicroSaaS sem código e a soberania dos Sistemas de Amplificação Pessoais (POS).*
...
* 📂 **Menu à esquerda (Pastas):** Você pode abrir e fechar as pastas de cada trilha para ver todos os artigos disponíveis.
* 🕸️ **Grafo à direita:** Mostra como as notas e temas se conectam visualmente entre si.
* 🔍 **Busca (`Ctrl + K` / `Cmd + K`):** Digite qualquer palavra para encontrar textos relacionados instantaneamente.

---
*Caderno sincronizado e publicado com Obsidian & Quartz v5.*
